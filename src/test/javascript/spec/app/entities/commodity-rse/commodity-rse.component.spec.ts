...
import { CommodityRseComponent } from 'app/entities/commodity-rse/commodity-rse.component';
...
describe('Component Tests', () => {
  describe('CommodityRse Management Component', () => {
    let comp: CommodityRseComponent;
    let fixture: ComponentFixture<CommodityRseComponent>;
    let service: CommodityRseService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [RseTestModule],
        declarations: [CommodityRseComponent],
        providers: [
          {
        ...
        .overrideTemplate(CommodityRseComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(CommodityRseComponent);
