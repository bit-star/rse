...
import { TagRseComponent } from 'app/entities/tag-rse/tag-rse.component';
import { TagRseService } from 'app/entities/tag-rse/tag-rse.service';
import { TagRse } from 'app/shared/model/tag-rse.model';

describe('Component Tests', () => {
  describe('TagRse Management Component', () => {
    let comp: TagRseComponent;
    let fixture: ComponentFixture<TagRseComponent>;
    let service: TagRseService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [RseTestModule],
        declarations: [TagRseComponent],
        providers: [
          {
        ...
        .overrideTemplate(TagRseComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(TagRseComponent);
