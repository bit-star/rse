...
import { PhotoRseComponent } from 'app/entities/photo-rse/photo-rse.component';
...
describe('Component Tests', () => {
  describe('PhotoRse Management Component', () => {
    let comp: PhotoRseComponent;
    let fixture: ComponentFixture<PhotoRseComponent>;
    let service: PhotoRseService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [RseTestModule],
        declarations: [PhotoRseComponent],
        providers: [
          {
        ...
        .overrideTemplate(PhotoRseComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(PhotoRseComponent);
