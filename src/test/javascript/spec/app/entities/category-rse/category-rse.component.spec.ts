...
import { CategoryRseComponent } from 'app/entities/category-rse/category-rse.component';
...
describe('Component Tests', () => {
  describe('CategoryRse Management Component', () => {
    let comp: CategoryRseComponent;
    let fixture: ComponentFixture<CategoryRseComponent>;
    let service: CategoryRseService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [RseTestModule],
        declarations: [CategoryRseComponent],
        providers: [
          {
        ...
        .overrideTemplate(CategoryRseComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(CategoryRseComponent);
