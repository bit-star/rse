...
import { OrderItemRseComponent } from 'app/entities/order-item-rse/order-item-rse.component';
...
describe('Component Tests', () => {
  describe('OrderItemRse Management Component', () => {
    let comp: OrderItemRseComponent;
    let fixture: ComponentFixture<OrderItemRseComponent>;
    let service: OrderItemRseService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [RseTestModule],
        declarations: [OrderItemRseComponent],
        providers: [
          {
        ...
        .overrideTemplate(OrderItemRseComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(OrderItemRseComponent);
