...
import com.lazulite.rse.domain.Tag;
import com.lazulite.rse.repository.TagRepository;
import com.lazulite.rse.service.TagService;
...
public class TagResourceIT {
    ...
    public void createTag() throws Exception {
        ...
        assertThat(testTag.getRemark()).isEqualTo(DEFAULT_REMARK);
    }
    ...
    public void updateTag() throws Exception {
        ...
        assertThat(testTag.getRemark()).isEqualTo(UPDATED_REMARK);
    }
