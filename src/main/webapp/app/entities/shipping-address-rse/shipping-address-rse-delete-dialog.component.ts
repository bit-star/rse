...
@Component({
  selector: 'jhi-shipping-address-rse-delete-dialog',
  templateUrl: './shipping-address-rse-delete-dialog.component.html'
})
export class ShippingAddressRseDeleteDialogComponent {
...
@Component({
  selector: 'jhi-shipping-address-rse-delete-popup',
  template: ''
})
export class ShippingAddressRseDeletePopupComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.activatedRoute.data.subscribe(({ shippingAddress }) => {
      setTimeout(() => {
        this.ngbModalRef = this.modalService.open(ShippingAddressRseDeleteDialogComponent as Component, { size: 'lg', backdrop: 'static' });
        this.ngbModalRef.componentInstance.shippingAddress = shippingAddress;
        this.ngbModalRef.result.then(
          result => {
            this.router.navigate(['/shipping-address-rse', { outlets: { popup: null } }]);
